...
namespace Kubernetes.KubeConfig.Models
{
    ...
    public class UserCredentials
    {
        ...
        public IList<string> ImpersonateGroups { get; set; } = new List<string>();

        /// <summary>
        /// Gets or sets additional information for impersonated user.
        /// </summary>
        [YamlMember(Alias = "as-user-extra", ApplyNamingConventions = false)]
        public IDictionary<string, string> ImpersonateUserExtra { get; set; } = new Dictionary<string, string>();
