...
public interface IKubernetesClientFactory
{
    ...
    /// </summary>
    /// <param name="name">The name of the client; Specify <c>null</c> or <see cref="string.Empty"/> for the default client.</param>
    /// <returns>The <see cref="KubernetesClient"/>.</returns>
    KubernetesClient CreateClient(string? name = null);
}